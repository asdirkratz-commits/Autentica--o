-- Migration: 0007_apps_parent (idempotente)
...
ALTER TABLE "apps"
  ADD COLUMN IF NOT EXISTS "parent_app_id" UUID REFERENCES "apps"("id") ON DELETE SET NULL;

CREATE INDEX IF NOT EXISTS "idx_apps_parent"
